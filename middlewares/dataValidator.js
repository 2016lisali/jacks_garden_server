...
export const createUserSchema = {
    firstName: {
        ...
        isAlpha: true,
        errorMessage:
            "firstName field cannot be empty and can only contain alphabet letters",
    },
    lastName: {
        notEmpty: true,
        isAlpha: true,
        errorMessage:
            "lastName field cannot be empty and can only contain alphabet letters",
    },
    isAdmin: {
        optional: true,
        isBoolean: true,
...
export const createCartDetailsSchema = {
    ...
    quantity: {
        ...
        errorMessage:
            "quantity can not be null and can only be an integer between 1 to 10",
    },
};
...
export const createAndUpdateProductSchema = {
    productName: {
        ...
        escape: true,
        errorMessage:
            "product name field cannot be empty and can only contain alphabet, numbers, space and -, the length can not be over 50",
    },
    category: {
        notEmpty: true,
        matches: { options: [/\b(?:indoor|outdoor|fruittree)\b/] },
        errorMessage:
            "category field cannot be empty, and can only be indoor/outdoor/fruittree",
    },
    productDescription: {
        notEmpty: true,
        escape: true,
        ...
        errorMessage:
            "product description field can not be empty and can not over 500 characters",
    },
    productImage: {
        optional: true,
    },
...
export const createOrderSchema = {
    userId: {
        ...
        errorMessage:
            "userId field cannot be empty and can only contain numbers",
    },
    orderDate: {
        notEmpty: true,
        isDate: true,
    ...
    orderAmount: {
        ...
        errorMessage:
            "Order amount field can not be empty and cannot be over 2000",
    },
    orderStatus: {
        notEmpty: true,
        matches: { options: [/\b(?:Paid)\b/i] },
        errorMessage:
            "Order status cannot be empty, and can only be string paid",
    },
    localPickup: {
        notEmpty: true,
        isBoolean: true,
...
export const updateOrderStatusSchema = {
    orderStatus: {
        ...
        errorMessage:
            "Order status cannot be empty, and can only be string paid/pending/completed",
    },
};
...
export const createOrderDetailsSchema = {
    orderId: {
        ...
        errorMessage:
            "orderId field cannot be empty and can only contain numbers",
    },
    productId: {
        notEmpty: true,
        isInt: {
        ...
        errorMessage:
            "productId field can not be empty and must bigger or equal than 1",
    },
    quantity: {
        notEmpty: true,
        isInt: {
    ...
    priceEach: {
        ...
        errorMessage:
            "priceEach cannot be empty, and can not be a negative number",
    },
};
...
export const createOrderBillingDetailsSchema = {
    ...
    name: {
        ...
        errorMessage:
            "name field cannot be empty and can only contain alphabets",
    },
    email: {
        optional: true,
        // isEmail: true,
    ...
    city: {
        ...
        isLength: { max: 20 },
        errorMessage:
            "city field can not be empty and can not be over 20 characters.",
    },
    state: {
        optional: true,
        escape: true,
        isLength: { max: 20 },
        errorMessage:
            "state can not be empty and can not be over 20 characters.",
    },
    postal_code: {
        notEmpty: true,
        isLength: { max: 10 },
        errorMessage:
            "postal_code can not be empty and can not be over 20 characters.",
    },
};
