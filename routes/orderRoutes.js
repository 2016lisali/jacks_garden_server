...
import {
    ...
    createOrderBillingDetailsSchema,
...
router.post(
    ...
    verifyTokenAndAuthentication,
    insertLog,
    validate(checkSchema(createOrderSchema)),
    createOrder
);
router.post(
    "/billings",
    verifyTokenAndAuthentication,
    insertLog,
    validate(checkSchema(createOrderBillingDetailsSchema)),
    createOrderBillingDetails
);
router.post(
    "/details",
    verifyTokenAndAuthentication,
    insertLog,
    validate(checkSchema(createOrderDetailsSchema)),
    createOrderDetails
);
router.patch(
    "/:id",
