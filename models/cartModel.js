...
export const createCart = (userId) => {
  return query("INSERT INTO carts (userId) " +
    "VALUES (?) ", [userId])
}
...
export const addCartDetails = (cartId, productId, quantity) => {
  return query("INSERT INTO cart_details (cartId, productId, quantity) " +
    "VALUES (?, ?,?) ",
    [cartId, productId, quantity])
}

export const updateCartDetails = (quantity, cartId, productId) => {
  return query("UPDATE cart_details " +
    "SET quantity=? " +
...
export const deleteCart = (userId) => {
  return query("DELETE FROM carts " +
    "WHERE userId=? ", [userId])
}

export const deleteProductInCart = (cartId, productId) => {
  return query("DELETE FROM cart_details " +
